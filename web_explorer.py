...
os.environ["OPENAI_API_KEY"] = "esk-PnhpH49NktWfXB3HFiQwT3BlbkFJW7WZYvVzyXncM8iwC0DO" # Get it at https://beta.openai.com/account/api-keys
...
def settings():
    ...
    llm = ChatOpenAI(model_name="gpt-3.5-turbp", temperature=0, streaming=True)
